package com.shvarsman.notes.presentation.navigation
...
import com.shvarsman.notes.presentation.screens.creation.CreateNoteScreen
import com.shvarsman.notes.presentation.screens.editing.EditNoteScreen
import com.shvarsman.notes.presentation.screens.notes.NotesScreen
...
fun NavGraph() {
    ...
    NavHost(
        ...
        composable(Screen.Notes.route) {
            NotesScreen(
                onNoteClick = {
                    navController.navigate(Screen.EditNote.createNote(it.id))
                },
                onAddNoteClick = {
...
sealed class Screen(val route: String) {
    ...
    data object EditNote : Screen("edit_note/{note_id}") { // Bundle("note_id" - "5")
        ...
        fun createNote(noteId: Int): String { // edit_note/5
